...
import static experienciausuario.FrmModulos.LbUser;
...
public class FrmVideo extends javax.swing.JFrame {
    ...
    public FrmVideo() {
       ...
       /* JBPlay1.setIcon(setIcon("/imagenes/play.png", JBPlay1));
        JBPause1.setIcon(setIcon("/imagenes/pause.png", JBPause1));
        JBPlay1.setContentAreaFilled(false);
        JBPause1.setContentAreaFilled(false);
        
        JBPlay2.setIcon(setIcon("/imagenes/play.png", JBPlay2));
        JBPause2.setIcon(setIcon("/imagenes/pause.png", JBPause2));
        JBPlay2.setContentAreaFilled(false);
        JBPause2.setContentAreaFilled(false);
        
        JBPlay3.setIcon(setIcon("/imagenes/play.png", JBPlay3));
        JBPause3.setIcon(setIcon("/imagenes/pause.png", JBPause3));
        JBPlay3.setContentAreaFilled(false);
        JBPause3.setContentAreaFilled(false);*/
    ...
    private void createScene1(){
        Platform.runLater(new Runnable() {
             ...
             public void run() {  
                    ...
                    File file = new File("src/videos/M1 Video 1.mp4");                                  
    ...
    private void createScene2(){
        Platform.runLater(new Runnable() {
             ...
             public void run() {     
                ...
                File file = new File("src/videos/M1 Video 2.mp4");                                  
    ...
    private void createScene3(){
        Platform.runLater(new Runnable() {
             ...
             public void run() {     
                ...
                File file = new File("src/videos/M1 Video 3.mp4");                                  
 ...
 void asiganarTiempo1() {
        try {
            ...
            Logger.getLogger(FrmVideo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
 ...
 public void actualizarBarraYTiempo3() {
    ...
    private void initComponents() {
        ...
        JBVideo3.setText("¿Cual es la diferencia entre el diseño UX y UI?");
        ...
        JBVideo1.setText("¿Que es UX o experiencia de usuario? ");
        ...
        JBVideo2.setText("¿Que es UI o un diseño de interfaz de usuario?");
        ...
        jLabel5.setText("<html>NOTA: Los videos estas hechos para verse en forma secuencial,por ende debes terminar de ver cada video por completo para poder avanzar al siguiente<html>");
        ...
        jPanel4.add(JLUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 20, 180, 40));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel4.setText("Bienvenido(a) a nuestro primer modulo ");
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 20, 490, 40));
    ...
    private void JBVideo6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBVideo6ActionPerformed
        ...
        FrmExamen.JLUser.setText(JLUsuario.getText());
