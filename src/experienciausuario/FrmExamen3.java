...
public class FrmExamen3 extends javax.swing.JFrame {
    ...
    public FrmExamen3() {
        ...
        String[]a= r.setRespuestas3(posicion);
    ...
    private void initComponents() {
        ...
        jPanel1.add(JLUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 30, 110, 40));
        ...
        getContentPane().add(JLNM2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 30, 30));
    ...
    private void JbAvanzarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbAvanzarActionPerformed
             ...
             FrmModulos.JLNotaMidulo3.setText(txtNota.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmExamen3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmExamen3().setVisible(true);
            }
        });
    }
