...
public class FrmExamen extends javax.swing.JFrame {
    ...
    private void JbAvanzarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbAvanzarActionPerformed
             ...
             v.setVisible(true);
             FrmModulos.JLNotaModulo1.setText(txtNota.getText());
             FrmModulos.LbUser.setText(JLUser.getText());
            if(FrmModulos.JLNotaModulo1.getText().equals("7") || FrmModulos.JLNotaModulo1.getText().equals("8") || FrmModulos.JLNotaModulo1.getText().equals("9") || FrmModulos.JLNotaModulo1.getText().equals("10") ){
            v.jButton2.setEnabled(true);
                }
             this.dispose();
