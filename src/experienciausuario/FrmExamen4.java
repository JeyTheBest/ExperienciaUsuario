...
import static experienciausuario.FrmExamen2.JLNM1;
import static experienciausuario.FrmModulos.JBFinModulos;
...
import static experienciausuario.FrmModulos.jButton4;
import java.awt.Toolkit;
import javax.swing.JOptionPane;
import javax.swing.table.DefaultTableModel;


public class FrmExamen4 extends javax.swing.JFrame {
    ...
    public FrmExamen4() {
        ...
        question.setText(p.getPregunta4(posicion));
        
        String[]a= r.setRespuestas4(posicion);
    ...
    private void initComponents() {
        ...
        jPanel1.add(JLUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 20, 110, 40));
        ...
        getContentPane().add(JLNM1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 30, 30));
        getContentPane().add(JLNM2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 30, 30));
        getContentPane().add(JLNM3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 30, 30));
    ...
    private void JbVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbVerificarActionPerformed
        ...
        for (int i = 0; i < 5; i++) {
            if(select[i].equals(r.getRespuesta4(i))){
    ...
    private void JbAvanzarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbAvanzarActionPerformed
             ...
             if(JLNotaModulo1.getText().equals("7") || JLNotaModulo1.getText().equals("8") || JLNotaModulo1.getText().equals("9") || JLNotaModulo1.getText().equals("10") ){
                ...
                FrmModulos.JLNotaMidulo2.setText(JLNM2.getText());
             ...
             FrmModulos.JLNotaMidulo3.setText(JLNM3.getText());
             if(v.JLNotaMidulo3.getText().equals("7") || v.JLNotaMidulo3.getText().equals("8") || v.JLNotaMidulo3.getText().equals("9") || v.JLNotaMidulo3.getText().equals("10") ){
                jButton4.setEnabled(true);
        }
             FrmModulos.JLNotaMidulo4.setText(txtNota.getText());
             if(v.JLNotaMidulo4.getText().equals("7") || v.JLNotaMidulo4.getText().equals("8") || v.JLNotaMidulo4.getText().equals("9") || v.JLNotaMidulo4.getText().equals("10") ){
                JBFinModulos.setEnabled(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmExamen4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmExamen4().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JLabel JLNM2;
    public static javax.swing.JLabel JLNM3;
